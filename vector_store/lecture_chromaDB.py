...
def build_skill_set_sentences(learning_guide):
    """
    learning_guide: learning_guide 한 행
...
def create_chromadb(data, db_name, embed_model):
    ...
    for i in tqdm(range(len(data))):
        ...
        if pd.isna(row['Learning Guide']):
            skill_parse = ''
        else:
            skill_parse = build_skill_set_sentences(row['Learning Guide'])
...
if __name__ == "__main__":
    ...
    create_chromadb(college_raw, 'lecture_college', embed_model)
