...
def create_employee_documents(DATA_DIR):
    # CSV 파일 읽기
    employee_df = pd.read_csv(os.path.join(DATA_DIR, "직원history.csv"))
    skillset_df = pd.read_csv(os.path.join(DATA_DIR, "skillset_data.csv"))
...
if __name__ == "__main__":
    ...
    create_employee_documents(DATA_DIR)